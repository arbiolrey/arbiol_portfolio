...
class Skills extends Component {
    ...
    render() {
        return (
            ...
            create visually appealing and highly functional web applications. From front-end development using HTML, CSS,KOTLIN,
             ANDROID STUDIO,FIGMA FRAME WORK JavaScript, and React to optimizing user experiences with responsive and accessible designs, I strive to bridge 
